    ...
    <div class="sidebar">
      ...
      <div class="nav">
          <ul class="nav-links">
            <li class="center"><a href="landing_page_admin.php">Home</a></li>
            <li class="center"><a href="daftar_menu.php">Menu</a></li>
            <li class="upward"><a href="pesanan.php">Pesanan</a></li>
            <li class="center"><a href="booking.php">Reservasi</a></li>
      ...
      <table class="table table-bordered" id="example">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?php echo $result["pemesan"]; ?></td>
            <td>Rp. <?php echo number_format($result["total_belanja"]); ?></td>
            <td><a href="edit_status.php?id=<?php echo $result['id_pemesanan'] ?>" class="badge badge-primary"><?php echo $result['keterangan']?></a></td>
            <td>
