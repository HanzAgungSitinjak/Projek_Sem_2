...
<html lang="en">
  ...
  <div class="nav-bar">
          ...
          <ul class="nav-links">
            ...
            <li class="upward"><a href="menu_unvalid.php">Menu</a></li>
            <li class="center"><a href="valid.php">Daftar Pesanan</a></li>
            ...
            <div class="card brder-dark">
              ...
              <div class="card-body">
               ...
               <label class="card-text harga"><strong>Rp.</strong> <?php echo number_format($result['harga']); ?></label><br>
                <a href="valid.php" class="btn btn-success btn-sm btn-block ">BELI</a>
              </div>
            </div>
          </div>
          <?php endforeach; ?>
