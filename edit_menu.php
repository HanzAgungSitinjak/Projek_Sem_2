 ...
 <!-- Form Registrasi -->
  <div class="container">
    ...
    <div class="card p-5 mb-5">
      <form method="POST" action="simpan_edit_menu.php" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" value="Minuman" name="jenis_menu" value="<?php echo $result[0]['jenis_menu'] ?>">Minuman
            </label>
          </div>
         </div>
        <div class="form-group">
